        ...
        children={
          <>
                ...
                modalBody={
                  <>
                    ...
                    <ErrorSnackbar
                      isOpen={snackbarOpen}
                      snackbarMessage={
                        "Exercise Name is required. Cannot be empty."
                      }
            ...
            >
              ...
              >
                {/* Header Row */}
                <Typography className="general-label">Set</Typography>
                <Typography className="general-label">Rep</Typography>
                <Typography className="general-label">Weight</Typography>
                <Typography className="general-label">Edit</Typography>
              </Stack>
              {/* Sets List */}

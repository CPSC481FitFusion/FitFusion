    ...
    <>
      ...
      >
        <div style={{ background: 'white', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
          ...
          <Typography variant="body1" id="confirmation-modal-description" paragraph>
            Are you sure you want to delete your goal?
          </Typography>
          <div>
            <ButtonFilled text="Cancel" style={"background-blue"} onClick={handleConfirmationModalClose} />
            <ButtonFilled text="Delete" style={"background-red"} onClick={handleDeleteConfirmation} />
          </div>
        </div>
      </Modal>
    </>
